...
export declare class Processor {
    ...
    getErrorMessageOnMatcherResult: (failureDetails: any) => string;
    getErrorMessageOnMatchToBe: (splittedErrorMessages: any) => string;
    getErrorMessageFromFailureMessage: (failureMessages: any) => string;
    private generate;
